    ...
    return (
        <>
            <div className=" flex justify-between">
                <h2 className=" font-ysabeau-office text-4xl font-black text-slate-500">Editar Producto</h2>
                <Link
                    to="/"
            ...
            >
                ...
                <div className="mb-4">
                    <label
                        className=" font-ysabeau-office text-gray-800"
                        htmlFor="availability"
                    >Disponibilidad:</label>
                    <select 
                        id="availability"
                        className=" font-ysabeau-office mt-2 block w-full p-3 bg-gray-50"
                        name="availability"
